<?php
$infoArray = array(
	array("Joshua Lohner", "Awesome", "Link to site", "Software Engineer", "lohnerj1@mymail.nku.edu", "8597391939"),
	array("Amrutha Rao", "Very cool", "Link to site", "Computer Scientist", "person2@nku.edu", "1233211233"),
	array("Doug Broughton", "Amazing", "Link to site", "Software Engineer", "person3@nku.edu", "5620641203"),
);

if (isset($_GET['id'])) {
	$identifier = $_GET['id'];

	$name = $infoArray[$identifier][0];
	$desc = $infoArray[$identifier][1];
	$link = $infoArray[$identifier][2];
	$title = $infoArray[$identifier][3];
	$email = $infoArray[$identifier][4];
	$phone = $infoArray[$identifier][5];
}
